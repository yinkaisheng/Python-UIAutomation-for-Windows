...
from typing import (Any, Callable, Dict, List, Iterable, Tuple, Optional, Union, Sequence)  # need 'pip install typing' for Python3.4 or lower
from .config import (DpiAwarenessBehavior, ProcessDpiAwareness, DpiAwarenessContext, DPI_AWARENESS_BEHAVIOR, DPI_AWARENESS_VALUE,
                     SEARCH_INTERVAL, MAX_MOVE_SECOND, TIME_OUT_SECOND, OPERATION_WAIT_TIME,
...
class Logger:
    ...
    @staticmethod
    def Write(log: Any, consoleColor: int = ConsoleColor.Default, writeToFile: bool = WRITE_LOG, printToStdout: bool = PRINT_LOG, logFile: Optional[str] = None, printTruncateLen: int = 0) -> None:
        """
        log: any type.
    ...
    @staticmethod
    def WriteLine(log: Any, consoleColor: int = ConsoleColor.Default, writeToFile: bool = WRITE_LOG, printToStdout: bool = PRINT_LOG, logFile: Optional[str] = None) -> None:
        """
        log: any type.
        consoleColor: int, a value in class `ConsoleColor`, such as `ConsoleColor.DarkGreen`.
        writeToFile: bool.
    ...
    @staticmethod
    def ColorfullyWrite(log: str, consoleColor: int = ConsoleColor.Default, writeToFile: bool = WRITE_LOG, printToStdout: bool = PRINT_LOG, logFile: Optional[str] = None) -> None:
        """
        log: str.
        consoleColor: int, a value in class `ConsoleColor`, such as `ConsoleColor.DarkGreen`.
        writeToFile: bool.
    ...
    @staticmethod
    def ColorfullyWriteLine(log: str, consoleColor: int = ConsoleColor.Default, writeToFile: bool = WRITE_LOG, printToStdout: bool = PRINT_LOG, logFile: Optional[str] = None) -> None:
        """
        log: str.
        consoleColor: int, a value in class `ConsoleColor`, such as `ConsoleColor.DarkGreen`.
        writeToFile: bool.
    ...
    @staticmethod
    def Log(log: Any = '', consoleColor: int = ConsoleColor.Default, writeToFile: bool = WRITE_LOG, printToStdout: bool = PRINT_LOG, logFile: Optional[str] = None) -> None:
        """
        log: any type.
        consoleColor: int, a value in class `ConsoleColor`, such as `ConsoleColor.DarkGreen`.
        writeToFile: bool.
    ...
    @staticmethod
    def ColorfullyLog(log: str = '', consoleColor: int = ConsoleColor.Default, writeToFile: bool = WRITE_LOG, printToStdout: bool = PRINT_LOG, logFile: Optional[str] = None) -> None:
        """
        log: any type.
        consoleColor: int, a value in class `ConsoleColor`, such as `ConsoleColor.DarkGreen`.
        writeToFile: bool.
...
if DPI_AWARENESS_BEHAVIOR == DpiAwarenessBehavior.ProcessDpiAwareness:
    #_dpi = _GetDictKeyName(DpiAwarenessBehavior.__dict__, DPI_AWARENESS_BEHAVIOR, lambda key: key[0] != '_')
    #_v = _GetDictKeyName(ProcessDpiAwareness.__dict__, DPI_AWARENESS_VALUE)
    #Logger.ColorfullyWrite('DPI <Color=Cyan>{}</Color> <Color=DarkGreen>{}</Color>\n'.format(_dpi, _v))
    assert ProcessDpiAwareness.DpiUnaware <= DPI_AWARENESS_VALUE <= ProcessDpiAwareness.PerMonitorDpiAware
    SetProcessDpiAwareness(DPI_AWARENESS_VALUE)
elif DPI_AWARENESS_BEHAVIOR == DpiAwarenessBehavior.ThreadDpiAwareness:
    #_dpi = _GetDictKeyName(DpiAwarenessBehavior.__dict__, DPI_AWARENESS_BEHAVIOR, lambda key: key[0] != '_')
    #_v = _GetDictKeyName(DpiAwarenessContext.__dict__, DPI_AWARENESS_VALUE)
    #Logger.ColorfullyWrite('DPI <Color=Cyan>{}</Color> <Color=DarkGreen>{}</Color>\n'.format(_dpi, _v))
    assert DpiAwarenessContext.UnawareGdiScaled <= DPI_AWARENESS_VALUE <= DpiAwarenessContext.Unaware
    SetThreadDpiAwarenessContext(DPI_AWARENESS_VALUE)
else:
    # do nothing
    pass
