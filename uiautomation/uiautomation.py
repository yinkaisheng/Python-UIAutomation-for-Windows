...
from .config import (DpiAwarenessBehavior, ProcessDpiAwareness, DpiAwarenessContext,
                     DPI_AWARENESS_BEHAVIOR, DPI_AWARENESS_VALUE, SEARCH_INTERVAL,
                     MAX_MOVE_SECOND, TIME_OUT_SECOND, OPERATION_WAIT_TIME,
