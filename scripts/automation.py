...
from uiautomation import (Logger, ControlFromCursor, Win32API, GetRootControl, GetFocusedControl,
                          EnumAndLogControl, EnumAndLogControlAncestors, VERSION)
...
def main():
    ...
    import getopt
    Logger.Write('UIAutomation {} (Python {}.{}.{})\n'.format(VERSION, *sys.version_info[:3]))
