...
def testNotepadCN():
    ...
    automation.SendKeys(u'{Ctrl}{End}{Enter}下面开始演示{! 4}{ENTER}', 0.2, 0)
    automation.SendKeys(text)
    automation.SendKeys('{Enter 3}0123456789{Enter}', waitTime = 0)
    automation.SendKeys('ABCDEFGHIJKLMNOPQRSTUVWXYZ{ENTER}', waitTime = 0)
    automation.SendKeys('abcdefghijklmnopqrstuvwxyz{ENTER}', waitTime = 0)
    automation.SendKeys('`~!@#$%^&*()-_=+{ENTER}', waitTime = 0)
